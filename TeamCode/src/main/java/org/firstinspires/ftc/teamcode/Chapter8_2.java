...
public class Chapter8_2 extends OpMode { // defines our class extending OpMode for iterative execution
    ...
    public void loop() { // called repeatedly while the OpMode is running
        board.setServoPosition(gamepad1.left_trigger); // sets servo position directly from left trigger (0 to 1)
    }
}
